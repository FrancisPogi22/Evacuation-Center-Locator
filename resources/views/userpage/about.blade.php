    ...
    <div class="wrapper">
        ...
        <main class="main-content">
            ...
            <section class="about-container">
                <div class="about-header">Cabuyao City Disaster Risk Reduction Management Office</div>
                    ...
                    <div class="right-side">
                        <div class="social-section">
                            ...
                            <a href="https://www.facebook.com/CabuyaoCDRRMO">
                                <p><i class="bi bi-facebook"></i>CDRRMO</p>
                            </a>
                            <hr>
                            <a href="#">
            ...
            <section class="about-container">
                <div class="about-header">CITY SOCIAL WELFARE AND DEVELOPMENT OFFICE</div>
                <div class="about-content">
                    <div class="location-section">
                        <div class="text-center">
                            <p>Address</p>
                    ...
                    <div class="right-side">
                        <div class="social-section">
                            ...
                            <hr>
                            <a href="https://www.facebook.com/CabuyaoCDRRMO">
                                <p><i class="bi bi-facebook"></i>CSWDO</p>
                            </a>
                            <hr>
                            <a href="#">
                                <p><i class="bi bi-twitter"></i>Example 2</p>
                        ...
                        <div class="telephone-section">
                            ...
                            <hr>
                            <a href="https://www.facebook.com/messages/t/242799609519367">
                                <p><i class="bi bi-messenger"></i>CSWDO CABUYAO</p>
                            </a>
                            <hr>
                            <p> <i class="bi bi-envelope-at"></i> cswdocabuyao@gmail.com</p>
                        </div>
                    </div>
                </div>
            </section>
